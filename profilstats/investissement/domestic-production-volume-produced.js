...
d3.csv("https://raw.githubusercontent.com/BenoitJPage/Datasets/main/StatsProfile/Investment/After_2000_StatsCan_APA_and_PPPC-Production-EN.csv")
    .then(function (data) {
        console.log(data);
    ...
    function lineChart(data, Product) {
        data = data.filter(d => (d.Product == Product) && (d.Unit == "cubic metres"))
        console.log(data)
