...
(function () {
  var draw_chart2 = function (event) {
    // Read the CSV file
    d3.csv("https://raw.githubusercontent.com/BenoitJPage/Datasets/main/StatsProfile/Economy/Revenue_goods_manufactured/After_2000-Revenue_goods_manufactured-Pulp_and_paper_product_manufacturing.csv")
        .then(function (data) {
            console.log(data);
