...
(function () {
    var draw_chart1 = function (event) {
      d3.csv("https://raw.githubusercontent.com/BenoitJPage/Datasets/main/StatsProfile/Economy/Canadian-housing-starts/After_2000-StatsCan-Housing_Starts-EN_FR.csv")
          .then(function (data) {
              console.log(data);
          ...
          svg.append("rect")
              ...
              .on("mousemove", function (event) {
                  ...
                  tooltip
                      ...
                      .html(`Year: <b>${d.Year}</b><br>Number of houses: <b>${Number.parseInt( d['Number'] ).toLocaleString( 'en-CA' )}</b>`);
              })
