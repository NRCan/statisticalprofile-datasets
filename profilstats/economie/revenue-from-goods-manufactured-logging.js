...
(function () {
  var draw_chart1 = function (event) {
    // Read the CSV file
    d3.csv("https://raw.githubusercontent.com/BenoitJPage/Datasets/main/StatsProfile/Economy/Revenue_goods_manufactured/After_2000-Revenue_goods_manufactured-Logging.csv")
    .then(function (data) {
        console.log(data);
        ...
        let dropdown = d3.select("#logging-select");
        ...
        dropdown.on("change", function () {
            ...
            d3.selectAll('#logging-chart svg').remove()
...
function lineChart(data, Jurisdiction) {
    data = data.filter(d => (d.Jurisdiction == Jurisdiction) && (d.Product == "Total logging"))
    ...
    const svg = d3.select("#logging-chart")  // Append SVG to body or any other container you'd prefer
        .append("svg")
