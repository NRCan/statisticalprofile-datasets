// Wood product manufacturing chart

  (function () {
    var draw_chart3 = function (event) {
      // Read the CSV file
      d3.csv("https://raw.githubusercontent.com/BenoitJPage/Datasets/main/StatsProfile/Economy/Revenue_goods_manufactured/After_2000-Revenue_goods_manufactured-Wood_product_manufacturing.csv")
      .then(function (data) {
          console.log(data);
          ...
          let dropdown = d3.select("#wood_product_manufacturing_jurisdiction-select");
          ...
          dropdown.on("change", function () {
              ...
              d3.selectAll('#wood_product_manufacturing-chart svg').remove()
  ...
  function lineChart(data, Jurisdiction) {
      data = data.filter(d => (d.Jurisdiction == Jurisdiction) && (d.Product == "Total wood product manufacturing"))
      ...
      const svg = d3.select("#wood_product_manufacturing-chart")  // Append SVG to body or any other container you'd prefer
          .append("svg")
