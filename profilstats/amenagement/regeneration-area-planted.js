...
(function () {
  var draw_chart1 = function (event) {
    // Read the CSV file
    d3.csv("https://raw.githubusercontent.com/BenoitJPage/Datasets/main/StatsProfile/Management/Regeneration/After_2000_NFD-Area_planted_by_ownership_and_species_group-EN_FR.csv")
    .then(function (data) {
        console.log(data);
        ...
        let dropdown = d3.select("#area_planted-select");
        ...
        dropdown.on("change", function () {
            ...
            d3.selectAll('#area_planted-chart svg').remove()
...
function barChart(data, Jurisdiction) {
    ...
    const svg = d3.select("#area_planted-chart")  // Append SVG to body or any other container you'd prefer
        .append("svg")
