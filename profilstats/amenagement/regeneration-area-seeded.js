...
(function () {
  var draw_chart2 = function (event) {
    // Read the CSV file
    d3.csv("https://raw.githubusercontent.com/BenoitJPage/Datasets/main/StatsProfile/Management/Regeneration/After_2000_NFD-Area_of_direct_seeding_by_ownership_and_application_method-EN_FR.csv")
        .then(function (data) {
            console.log(data);
            ...
            let dropdown = d3.select("#area_seeded-select");
            ...
            dropdown.on("change", function () {
                ...
                d3.selectAll('#area_seeded-chart svg').remove()
    ...
    function barChart(data, Jurisdiction) {
        ...
        const svg = d3.select("#area_seeded-chart")  // Append SVG to body or any other container you'd prefer
            .append("svg")
        ...
        svg.selectAll(".bar")
            ...
            .on("mousemove", function (event, d) {
                ...
                tooltip
                    ...
                    .html(`Year: <b>${d.Year}</b><br>Area: <b>${Number.parseInt( d['Area'] ).toLocaleString( 'en-CA' )}</b>`);
            })
            .on("mouseout", function () {
                tooltip.style("display", "none");
                d3.select(this).attr('fill', '#1b6c1c');
            });
