...
(function () {
    var draw_chart1 = function (event) {
      // Read the CSV file
      d3.csv("https://raw.githubusercontent.com/BenoitJPage/Datasets/main/StatsProfile/Management/Harvesting/After_2000_NFD-Area_harvested_by_ownership_and_harvesting_method-EN_FR.csv")
      .then(function (data) {
          console.log(data);
          ...
          let dropdown = d3.select("#area_harvested-select");
          ...
          dropdown.on("change", function () {
              ...
              d3.selectAll('#area_harvested-chart svg').remove()
  ...
  function barChart(data, Jurisdiction) {
      ...
      const svg = d3.select("#area_harvested-chart")  // Append SVG to body or any other container you'd prefer
          .append("svg")
      ...
      svg.selectAll(".bar")
          ...
          .on("mouseout", function () {
              ...
              d3.select(this).attr('fill', '#335075');
          });
