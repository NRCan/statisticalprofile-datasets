// Area certified chart
    ...
    (function () {
      var draw_chart1 = function (event) {
        // Read the CSV file
        d3.csv("https://raw.githubusercontent.com/BenoitJPage/Datasets/main/StatsProfile/Management/Third-party%20certification/After_2000_FPAC-Certification_no_CA-National.csv")
            .then(function (data) {
                console.log(data);
