...
(function () {
    var draw_chart2 = function (event) {
      ...
      d3.csv("https://raw.githubusercontent.com/BenoitJPage/Datasets/main/StatsProfile/Management/Harvesting/After_2000_NFD-Net_Merchantable_Volume_of_Roundwood_Harvested_by_Category_and_Ownership-EN_FR.csv")
            .then(function (data) {
                console.log(data);
            ...
            svg.append("rect")
                ...
                .on("mousemove", function (event) {
                    ...
                    tooltipCircle
                        ...
                        .attr("cy", yScale(+d['Volume']));

                    tooltip
                        .style("left", `${event.pageX + 10}px`)
                        .style("top", `${event.pageY - 300}px`)
                        .html(`Year: <b>${d.Year}</b><br>Volume(m³): <b>${Number.parseInt( d['Volume'] ).toLocaleString( 'en-CA' )}</b>`);
                })
