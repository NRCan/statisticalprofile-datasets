//Carbon for forest land chart 

(function () {
    var draw_chart1 = function (event) {
      d3.csv("https://raw.githubusercontent.com/BenoitJPage/Datasets/main/StatProfile-2024_data/Carbon/StatProfile_Carbon_Afforest_EN.csv")
          .then(function (data) {
              console.log(data);
              ...
              let dropdown = d3.select("#greenhouse_gas_total_emissions-select");
              ...
              dropdown.on("change", function () {
                  ...
                  d3.selectAll('#greenhouse_gas_total_emissions-chart svg').remove()
      ...
      function lineChart(data, Measure) {
          ...
          const svg = d3.select("#greenhouse_gas_total_emissions-chart")  // Append SVG to body or any other container you'd prefer
              .append("svg")
          ...
          svg.append("text")
              ...
              .attr("text-anchor", "middle")
              .attr("font-size", "13px")
              .text("Émissions et absorptions de gaz à effet de serre (million de tonnes d'équivalent CO₂/an)");
          ...
          svg.append("rect")
              ...
              .on("mousemove", function (event) {
                  ...
                  tooltip
                      ...
                      .html(`Year: <b>${d.Year}</b><br>Greenhouse gas emissions and removals: <b>${( d['Value'] ).toLocaleString( 'en-CA' )}</b>`);
              })
