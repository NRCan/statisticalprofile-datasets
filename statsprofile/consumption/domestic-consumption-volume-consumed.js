      ...
      var draw_chart1 = function (event) {
        ...
        d3.csv("https://raw.githubusercontent.com/BenoitJPage/Datasets/main/StatProfile-2024_data/Consumption/StatProfile_Trade_comsumption_EN.csv")
            .then(function (data) {
                ...
                let unique = ["Hardwood lumber (cubic metres)", "Softwood lumber (cubic metres)", "Structural panels (plywood and oriented strandboard, cubic metres)"];

                // Get the dropdown element
                let dropdown = d3.select("#volume_consumed-select");
                ...
                dropdown.on("change", function () {
                    ...
                    d3.selectAll('#volume_consumed-chart svg').remove()
            ...
            const svg = d3.select("#volume_consumed-chart")  // Append SVG to body or any other container you'd prefer
                .append("svg")
