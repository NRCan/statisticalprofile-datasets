// Wood product manufacturing chart
  ...
  (function () {
    var draw_chart3 = function (event) {
      // Read the CSV file
      d3.csv("https://raw.githubusercontent.com/BenoitJPage/Datasets/main/StatProfile-2024_data/Economy/StatProfile_Economy_revenue_wood_EN.csv")
      .then(function (data) {
          console.log(data);
          ...
          dropdown.selectAll("option.data-option")
           ...
           // Extract unique values from Product column
           let uniqueProduct = [...new Set(data.map(item => item.Product))];
           
           // Get the dropdown element
           let dropdownProduct = d3.select("#wood_product_manufacturing_product-select");
