...
(function () {
    var draw_chart1 = function (event) {
      d3.csv("https://raw.githubusercontent.com/BenoitJPage/Datasets/refs/heads/main/StatProfile-2024_data/Carbon/StatProfile_Carbon_Afforest_EN.csv")
          .then(function (data) {
              console.log(data);
      ...
      function lineChart(data, Measure) {
          ...
          svg.append("text")
              ...
              .attr("text-anchor", "middle")
              .attr("font-size", "13px")
              .text("Greenhouse gas emissions and removals (million tonnes CO₂e/year)");
