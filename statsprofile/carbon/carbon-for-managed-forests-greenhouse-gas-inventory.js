...
(function () {
  var draw_chart2 = function (event) {
    // Read the CSV file
    d3.csv("https://raw.githubusercontent.com/BenoitJPage/Datasets/refs/heads/main/StatProfile-2024_data/Carbon/StatProfile_Carbon_TotalEmmissions_EN.csv")
            .then(function (data) {
                console.log(data);
        ...
        function barChart(data, Measure) {
            ...
            textElement.append("tspan")
                ...
                .text(" e/yr, megatonnes"); // Append the rest of the text
