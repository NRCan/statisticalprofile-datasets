// Maple products trade value chart
    ...
    var draw_chart2 = function (event) {
      ...
      d3.csv("https://raw.githubusercontent.com/BenoitJPage/Datasets/main/StatProfile-2024_data/Trade/StatProfile_Trade_Maple_EN.csv")
          .then(function (data) {
              ...
              let dropdown = d3.select("#maple_products_value_commodity-select");
              ...
              let uniqueType = [...new Set(data.map(item => item['Trade type']))];
                  ...
                  // Get the dropdown element
                  let dropdownType = d3.select("#maple_products_value_type-select");
              ...
              dropdown.on("change", function () {
                  ...
                  d3.selectAll('#maple_products_value-chart svg').remove()
      ...
      function lineChart(data, Commodity, Type) {
          ...
          const svg = d3.select("#maple_products_value-chart")  // Append SVG to body or any other container you'd prefer
              .append("svg")
