    ...
    var draw_chart2 = function (event) {
      ...
      d3.csv("https://raw.githubusercontent.com/BenoitJPage/Datasets/main/StatProfile-2024_data/Trade/StatProfile_Trade_Exports_quantity_EN.csv")
          .then(function (data) {
            ...
            //   let dropdown = d3.select("#pulp_and_paper_products_jurisdiction-select");
            ...
            //       .attr("value", d => d); 
              ...
              let uniqueProduct = ["Newsprint (tonnes)", "Wood pulp (air dry metric tonnes)", "Other paper and paperboard (tonnes)"];
  
                  // Get the dropdown element
                  let dropdownProduct = d3.select("#pulp_and_paper_products_product-select");
            ...
            //       d3.selectAll('#pulp_and_paper_products-chart svg').remove()
      ...
      function lineChart(data, Product) {
          ...
          data = data.filter(d => (d.Jurisdiction == "Canada") && (d.Product == Product) && (d['Commodity Group'] == "Pulp and Paper Products"))
          ...
          const svg = d3.select("#pulp_and_paper_products-chart")  // Append SVG to body or any other container you'd prefer
              .append("svg")
