...
(function () {
    var draw_chart1 = function (event) {
      d3.csv("https://raw.githubusercontent.com/BenoitJPage/Datasets/main/StatProfile-2024_data/Trade/StatProfile_Trade_MapleProdValue_EN.csv")
          .then(function (data) {
              console.log(data);
              ...
              let dropdown = d3.select("#maple_products_production_value_jurisdiction-select");
              ...
              dropdown.on("change", function () {
                  ...
                  d3.selectAll('#maple_products_production_value-chart svg').remove()
      ...
      function lineChart(data, Jurisdiction) {
          ...
          const svg = d3.select("#maple_products_production_value-chart")  // Append SVG to body or any other container you'd prefer
              .append("svg")
