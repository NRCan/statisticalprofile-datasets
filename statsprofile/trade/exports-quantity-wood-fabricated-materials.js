// Wood-Fabricated Materials chart

(function () {
    var draw_chart3 = function (event) {
      // Read the CSV file
      d3.csv("https://raw.githubusercontent.com/BenoitJPage/Datasets/main/StatProfile-2024_data/Trade/StatProfile_Trade_Exports_quantity_EN.csv")
          .then(function (data) {
              console.log(data);
            ...
            //   let dropdown = d3.select("#wood_fabricated_materials_jurisdiction-select");
            ...
            //       .attr("value", d => d); 
              ...
              let uniqueProduct = ["Hardwood lumber (cubic metres)", "Oriented strandboard (cubic metres)", "Particleboard (cubic metres)", "Plywood (cubic metres)", "Softwood lumber (cubic metres)", "Veneer (square metres)"];
  
                  // Get the dropdown element
                  let dropdownProduct = d3.select("#wood_fabricated_materials_product-select");
            ...
            //       d3.selectAll('#wood_fabricated_materials-chart svg').remove()
      ...
      function lineChart(data, Product) {
          ...
          data = data.filter(d => (d.Jurisdiction == "Canada") && (d.Product == Product) && (d['Commodity Group'] == "Wood-Fabricated Materials"))
          ...
          const svg = d3.select("#wood_fabricated_materials-chart")  // Append SVG to body or any other container you'd prefer
              .append("svg")
          ...
          // Define axes
          const xAxis = d3.axisBottom(xScale).ticks(18).tickFormat(d3.format("d")).tickSizeOuter(0);
