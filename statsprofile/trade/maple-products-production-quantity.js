// Maple products production quantity chart 

(function () {
    var draw_chart1 = function (event) {
      d3.csv("https://raw.githubusercontent.com/BenoitJPage/Datasets/main/StatProfile-2024_data/Trade/StatProfile_Trade_MapleProdQuantity_EN.csv")
          .then(function (data) {
              console.log(data);
              ...
              let dropdown = d3.select("#maple_products_production_quantity_jurisdiction-select");
              ...
              dropdown.on("change", function () {
                  ...
                  d3.selectAll('#maple_products_production_quantity-chart svg').remove()
      ...
      function lineChart(data, Jurisdiction) {
          ...
          const svg = d3.select("#maple_products_production_quantity-chart")  // Append SVG to body or any other container you'd prefer
              .append("svg")
          ...
          const yScale = d3.scaleLinear()
              .domain([0, d3.max(data, d => +d['Quantity (liters)'])])
              .range([height, 0]).nice();
          ...
          svg.append("rect")
              ...
              .on("mousemove", function (event) {
                  ...
                  tooltipCircle
                      ...
                      .attr("cy", yScale(+d['Quantity (liters)']));

                  tooltip
                      .style("left", `${event.pageX + 10}px`)
                      .style("top", `${event.pageY - 300}px`)
                      .html(`Year: <b>${d.Year}</b><br>Quantity: <b>${Number.parseInt( d['Quantity (liters)'] ).toLocaleString( 'en-CA' )}</b>`);
              })
