...
(function () {
    var draw_chart1 = function (event) {
      // Read the CSV file
      d3.csv("https://raw.githubusercontent.com/BenoitJPage/Datasets/main/StatProfile-2024_data/Management/Forest-harvesting/StatProfile_Management_harvest_EN.csv")
      .then(function (data) {
          console.log(data);
  ...
  function barChart(data, Jurisdiction) {
      ...
      svg.selectAll(".bar")
          ...
          .on("mouseover", function () {
              ...
              d3.select(this).attr('fill', '#7D828B');
          })
