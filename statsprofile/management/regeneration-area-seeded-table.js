// Area seeded table
    ...
    (function () {
      var draw_table2 = function (event) {
        ...
        d3.csv(
          "https://raw.githubusercontent.com/BenoitJPage/Datasets/main/StatProfile-2024_data/Management/Artificial-forest-regeneration/StatProfile_Management_seeded_EN.csv",
          ).then(function (data) {
