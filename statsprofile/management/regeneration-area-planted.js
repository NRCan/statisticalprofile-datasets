...
(function () {
  var draw_chart1 = function (event) {
    // Read the CSV file
    d3.csv("https://raw.githubusercontent.com/BenoitJPage/Datasets/main/StatProfile-2024_data/Management/Artificial-forest-regeneration/StatProfile_Management_planted_EN.csv")
    .then(function (data) {
        console.log(data);
