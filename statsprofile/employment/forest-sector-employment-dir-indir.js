// Direct and indirect employment chart

(function () {
    var draw_chart1 = function (event) {
      // Read the CSV file
      d3.csv("https://raw.githubusercontent.com/BenoitJPage/Datasets/main/StatProfile-2024_data/Employment/StatProfile_Employment_Dir%26Indir_EN.csv")
          .then(function (data) {
              console.log(data);
      ...
      function lineChart(data) {
          ...
          const svg = d3.select("#dir_indir-chart")  // Append SVG to body or any other container you'd prefer
              .append("svg")
          ...
          svg.append("rect")
              ...
              .on("mousemove", function (event) {
                  ...
                  tooltip
                      ...
                      .html(`Year: <b>${d.Year}</b><br>Number of jobs: <b>${Number.parseInt( d['Number'] ).toLocaleString( 'en-CA' )}</b>`);
              })
