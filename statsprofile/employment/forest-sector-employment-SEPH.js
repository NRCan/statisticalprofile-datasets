...
(function () {
    var draw_chart1 = function (event) {
      // Read the CSV file
      d3.csv("https://raw.githubusercontent.com/BenoitJPage/Datasets/main/StatProfile-2024_data/Employment/StatProfile_Employment_SEPH_EN.csv")
          .then(function (data) {
              console.log(data);
              ...
              let dropdown = d3.select("#seph_jurisdiction-select");
              ...
              let uniqueSector = [...new Set(data.map(item => item.Sector))];
                  ...
                  // Get the dropdown element
                  let dropdownSector = d3.select("#seph_sector-select");
              ...
              dropdown.on("change", function () {
                  ...
                  d3.selectAll('#seph-chart svg').remove()
      ...
      function lineChart(data, Jurisdiction, Sector) {
          ...
          const svg = d3.select("#seph-chart")  // Append SVG to body or any other container you'd prefer
              .append("svg")
          ...
          svg.append("rect")
              ...
              .on("mousemove", function (event) {
                  ...
                  tooltipCircle
                      ...
                      .attr("cy", yScale(+d['Employees']));
  
                  tooltip
                      .style("left", `${event.pageX + 10}px`)
                      .style("top", `${event.pageY - 300}px`)
                      .html(`Year: <b>${d.Year}</b><br>Number of employees: <b>${Number.parseInt( d['Employees'] ).toLocaleString( 'en-CA' )}</b>`);
              })
