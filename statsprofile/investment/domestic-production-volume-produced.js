// Volume produced chart

(function () {
    var draw_chart1 = function (event) {

// load the data from the CSV file
d3.csv("https://raw.githubusercontent.com/BenoitJPage/Datasets/main/StatProfile-2024_data/Investment/StatProfile_Investment_Production_EN.csv")
    .then(function (data) {
        console.log(data);

        // Extract unique values from NAICS column
        let unique = ["Lumber - hardwood", "Lumber - softwood", "Structural panels (Plywood and Oriented Strandboard)"];

        // Get the dropdown element
        let dropdown = d3.select("#volume_produced-select");
        ...
        dropdown.on("change", function () {
            ...
            d3.selectAll('#volume_produced-chart svg').remove()
    ...
    function lineChart(data, Product) {
        data = data.filter(d => (d['Forest Product'] == Product) && (d['Unit of measure'] == "cubic metres" || "Cubic meters"));
        console.log(data)
    ...
    const svg = d3.select("#volume_produced-chart")
        .append("svg")
    ...
    svg.append("rect")
        ...
        .on("mousemove", function (event) {
            ...
            tooltip
                ...
                .html(`Year: <b>${d.Year}</b><br>Volume(m³): <b>${Number.parseInt( d['Value'] ).toLocaleString( 'en-CA' )}</b>`);
        })
